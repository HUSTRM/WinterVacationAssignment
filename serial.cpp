...
//将short x,y,z依次转成byte类型
    short2byte(&sendata[1], x);
    short2byte(&sendata[3], y);
    //short2byte(&sendata[5],z);
...
void SerialCom::short2byte(BYTE *hexdata, short ddata)
{
    unsigned char str[128];
    sprintf((char*)str, "%hd", ddata);
    hexdata[0] = str[0];
    hexdata[1] = str[1];
    /*hexdata[2] = str[2];
    hexdata[3] = str[3];*/
